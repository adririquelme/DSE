function varargout = gui_ppalpoleseditor_v02(varargin)
% GUI_PPALPOLESEDITOR_V02 MATLAB code for gui_ppalpoleseditor_v02.fig
%      GUI_PPALPOLESEDITOR_V02, by itself, creates a new GUI_PPALPOLESEDITOR_V02 or raises the existing
%      singleton*.
%
%      H = GUI_PPALPOLESEDITOR_V02 returns the handle to a new GUI_PPALPOLESEDITOR_V02 or the handle to
%      the existing singleton*.
%
%      GUI_PPALPOLESEDITOR_V02('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in GUI_PPALPOLESEDITOR_V02.M with the given input arguments.
%
%      GUI_PPALPOLESEDITOR_V02('Property','Value',...) creates a new GUI_PPALPOLESEDITOR_V02 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before gui_ppalpoleseditor_v02_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to gui_ppalpoleseditor_v02_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help gui_ppalpoleseditor_v02

% Last Modified by GUIDE v2.5 15-Mar-2015 14:23:06

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @gui_ppalpoleseditor_v02_OpeningFcn, ...
                   'gui_OutputFcn',  @gui_ppalpoleseditor_v02_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before gui_ppalpoleseditor_v02 is made visible.
function gui_ppalpoleseditor_v02_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to gui_ppalpoleseditor_v02 (see VARARGIN)

% Choose default command line output for gui_ppalpoleseditor_v02
...
% UIWAIT makes gui_ppalpoleseditor_v02 wait for user response (see UIRESUME)
% uiwait(handles.figure1);



% --- Outputs from this function are returned to the command line.
function varargout = gui_ppalpoleseditor_v02_OutputFcn(hObject, eventdata, handles) 
