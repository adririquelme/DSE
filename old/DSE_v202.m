function varargout = DSE_v202(varargin)
...
% DSE_v202 MATLAB code for DSE_v202.fig
%      DSE_v202, by itself, creates a new DSE_v202 or raises the existing
%      singleton*.
%
%      H = DSE_v202 returns the handle to a new DSE_v202 or the handle to
%      the existing singleton*.
%
%      DSE_v202('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in DSE_V06.M with the given input arguments.
%
%      DSE_v202('Property','Value',...) creates a new DSE_V06 or raises the
...
% Edit the above text to modify the response to help DSE_v202

% Last Modified by GUIDE v2.5 10-Aug-2015 18:18:57
...
% Choose default command line output for DSE_v202
