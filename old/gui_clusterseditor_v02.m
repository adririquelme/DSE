function varargout = gui_clusterseditor_v02(varargin)
% GUI_CLUSTERSEDITOR_V02 MATLAB code for gui_clusterseditor_v02.fig
%      GUI_CLUSTERSEDITOR_V02, by itself, creates a new GUI_CLUSTERSEDITOR_V02 or raises the existing
%      singleton*.
%
%      H = GUI_CLUSTERSEDITOR_V02 returns the handle to a new GUI_CLUSTERSEDITOR_V02 or the handle to
%      the existing singleton*.
%
%      GUI_CLUSTERSEDITOR_V02('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in GUI_CLUSTERSEDITOR_V02.M with the given input arguments.
%
%      GUI_CLUSTERSEDITOR_V02('Property','Value',...) creates a new GUI_CLUSTERSEDITOR_V02 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before gui_clusterseditor_v02_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to gui_clusterseditor_v02_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help gui_clusterseditor_v02

% Last Modified by GUIDE v2.5 10-Mar-2020 14:00:21

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @gui_clusterseditor_v02_OpeningFcn, ...
                   'gui_OutputFcn',  @gui_clusterseditor_v02_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before gui_clusterseditor_v02 is made visible.
function gui_clusterseditor_v02_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to gui_clusterseditor_v02 (see VARARGIN)

% Choose default command line output for gui_clusterseditor_v02
...
polos_estereoppalasignados_afterdbscan=getappdata(0,'polos_estereoppalasignados_afterdbscan');
% Configuro el slider
...
handles.polos_estereoppalasignados_afterdbscan=polos_estereoppalasignados_afterdbscan;
% Update handles structure
guidata(hObject, handles);

% UIWAIT makes gui_clusterseditor_v02 wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = gui_clusterseditor_v02_OutputFcn(hObject, eventdata, handles) 
...
polos_estereoppalasignados_afterdbscan=handles.polos_estereoppalasignados_afterdbscan;
...
handles.puntos_familia_cluster=puntos_familia_cluster;
handles.familia_cluster_plano=familia_cluster_plano;
handles.polos_estereoppalasignados_afterdbscan_limpio =polos_estereoppalasignados_afterdbscan_limpio ;
...
setappdata(0,'polos_estereoppalasignados_afterdbscan_limpio',polos_estereoppalasignados_afterdbscan_limpio);
guidata(hObject,handles)
...
[ puntos_familia_cluster, familia_cluster_plano, polos_estereoppalasignados_afterdbscan_limpio ] = f_clusterclear_v02( puntos_familia_cluster, familia_cluster_plano , ds, ppclusterallds,polos_estereoppalasignados_afterdbscan);
% [ puntos_familia_cluster, familia_cluster_plano ] = f_clusterclear_v02( puntos_familia_cluster, familia_cluster_plano , ds, ppclusterds);
% Traslado los puntos para que D esté en su CDG
[familia_cluster_plano_tuneada] = f_tabla_homogeneizaD(familia_cluster_plano);
% represento la salida en la matriz
